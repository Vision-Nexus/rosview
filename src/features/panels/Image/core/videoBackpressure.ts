...
export const VIDEO_MAX_PENDING_SPAN_MS = 1_000;
...
export const VIDEO_OUTPUT_DEADLINE_MS = 120;
...
export function shouldDropDecodedVideoFrame(
  playbackTimeNs: bigint | null,
  frameTimeNs: bigint,
  deadlineMs = VIDEO_OUTPUT_DEADLINE_MS,
): boolean {
