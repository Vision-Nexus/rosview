...
function u(e) {
	...
	for (let t of Array.from(e.children)) switch (t.nodeName) {
		case "visual":
			n.visuals.push(f(t));
			break;
		case "collision": n.colliders.push(p(t));
	}
	return n;
}
function d(e) {
...
function v(e) {
	...
	for (let n of Array.from(e.children)) switch (n.nodeName) {
		case "color":
			t.color = b(n, "rgba") ?? void 0;
			break;
		case "texture": t.texture = n.getAttribute("filename") ?? void 0;
	}
	return t;
}
function y(e) {
...
var k = new n.Vector3(1, 1, 1), A = new n.Matrix4(), j = new n.Vector3(1, 1, 1), M = /* @__PURE__ */ new Map(), N = "__ros3d_edge_outline__", P = 30, ee = 1e4, F = /* @__PURE__ */ new WeakMap();
...
function R(e, t) {
	return new n.Matrix4().compose(new n.Vector3(e.x, e.y, e.z), new n.Quaternion(t.x, t.y, t.z, t.w), k);
}
function z(t, n) {
	let r = e(n), i = t.get(r);
...
function V(t, n, r) {
	...
	let o = (e, n) => {
		...
		n && a ? r.matrix.multiplyMatrices(n, a) : a ? r.matrix.copy(a) : r.matrix.identity(), r.matrix.decompose(r.position, r.rotation, j);
...
function Z(e) {
	if (X(e) > ee) return;
	let t = F.get(e);
	return t || (t = new n.EdgesGeometry(e, P), F.set(e, t)), t;
}
function Q(e, t) {
	if (e.children.some((e) => e.name === N)) return;
	let r = Z(e.geometry);
	if (!r) return;
	...
	a.name = N, a.renderOrder = 1, e.add(a);
}
async function te(e, t, r) {
	let i = e.geometry, a = i.filename, o = r.resolveMeshUrl(a), s = await ne(o, O(a, o));
	if (s.ok === !1) {
	...
	try {
		...
		return e = s.asset.kind === "stl" ? re(s.asset.buffer, t, r.meshUpAxis ?? "y_up") : s.asset.kind === "obj" ? ie(s.asset.text, t, r.meshUpAxis ?? "y_up") : ae(s.asset.text, o, r.meshUpAxis ?? "y_up"), i.scale && e.scale.set(i.scale.x, i.scale.y, i.scale.z), e.traverse((e) => {
			...
			let a = !1, o = !1;
			Array.isArray(i.material) || (!i.material || i.material instanceof n.MeshBasicMaterial ? (i.material = q(t), a = !0) : o = J(i.material), (s.asset.kind === "stl" || s.asset.kind === "obj" || a && !o) && Q(i, r.outlineColor ?? "#94a3b8"));
		}), e;
	} catch (e) {
...
function ae(e, t, n) {
	...
	if (!o) throw Error(`Failed to parse Collada mesh: ${t}`);
...
function le(t, n) {
	...
	for (let n of t.frameObjects) {
		if (!t.hasRealtimeTf) {
			...
			if (a && o) A.copy(o.matrix).invert().multiply(a.matrix), A.decompose(n.object.position, n.object.quaternion, j), n.object.visible = !0;
			else {
