import { f as e, i as t, s as n, t as r } from "./rafScheduler-D3aT-VUS.js";
import { f as i } from "./TopicQuickPicker-djRSFqzq.js";
import { g as a, m as o, n as s, r as c, t as l, x as u } from "./resizable-G3yGH-Qg.js";
import { t as d } from "./messageBus-tPJ7Uycq.js";
import { _ as f, a as p, c as m, d as h, f as g, g as _, h as v, i as y, l as b, m as x, n as S, o as C, p as w, r as T, s as E, t as D, u as ee, v as te, y as ne } from "./meshBaseStatus-SSFol-nk.js";
		...
		children: [
			...
			/* @__PURE__ */ N("div", {
				...
				children: d.length === 0 ? /* @__PURE__ */ N("p", {
					...
					let n = H(e, t.manualJointPositions, a, t.followLiveJointState);
					return /* @__PURE__ */ N(G, {
						descriptor: e,
						value: n,
...
var we = ({ player: n, panelId: i, config: a, setConfig: u }) => {
	...
	A(() => {
		...
		let e = () => {
			let e = d.getLastMessage(U), t = g(e?.message);
			t && z((e) => e === t ? e : t);
		};
		e();
	...
	let X = j(() => f({
		...
		let n = S(e), r = [];
		try {
			let t = h(e, a.rotateMeshVisuals, a.visualRpyOffset);
			r = E(t);
		} catch {
			r = [];
		}
