import { f as e, i as t, r as n } from "./rafScheduler-BAifbkGY.js";
...
import { a as s, d as c, f as l, i as u, l as d, n as f, p, r as m, t as h } from "./r3fZUpSceneChrome-D9DAkdCt.js";
...
var P = ({ signature: e }) => {
	...
	let r = y(() => e.samples.map((e) => e.position), [e.samples]), i = y(() => j(r, t, n), [
		n,
		t,
		r
	]);
	return /* @__PURE__ */ C(S, { children: i.map((t) => /* @__PURE__ */ C(F, {
		band: t,
		color: e.color
	}, `${e.topic}:${t.key}`)) });
